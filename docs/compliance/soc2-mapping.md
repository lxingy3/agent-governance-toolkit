...
| Control | Feature | Location | Coverage |
|---------|---------|----------|----------|
| CC5.1 Risk-mitigating controls | AgentControl — every agent action evaluated before execution | `agent-governance-python/agt-policies/src/agt/policies/runtime.py` | ✅ Covered |
...
| CC5.2 Policy modes | Strict (deny-by-default), permissive (allow-by-default), audit (log-only) | `agent-governance-python/agt-policies/src/agt/policies/manifest.py:34-41` | ✅ Covered |
...
| CC7.2 Change monitoring | Version-controlled the ACS manifest with name, version, description fields | `agent-governance-python/agt-policies/src/agt/policies/manifest.py:70-115` | ⚠️ Partial |
...
| Control | Feature | Location | Coverage |
|---------|---------|----------|----------|
| PI1.1 Input validation | AgentControl validates every action against declarative rules before execution | `agent-governance-python/agt-policies/src/agt/policies/runtime.py` | ✅ Covered |
...
| `src/agent_os/policies/schema.py:34-115` | CC5.2, CC7.2 — the ACS manifest, PolicyRule, PolicyEvaluation |
