...
|-----------|----------|-------------|
| **AgentControlMiddleware** | `AgentMiddleware` | Enforces declarative policies: token limits, rate limiting, blocked patterns, content safety |
...
policy_mw = AgentControlMiddleware(
    policy_directory="policies/",
